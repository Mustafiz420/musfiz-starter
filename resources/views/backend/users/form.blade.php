                    ...
                    <div class="col-md-8">
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                ...
                                <x-forms.textbox label="Name" type="email" name="name"
                    ...
                    <div class="col-md-4">
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                ...
                                {{-- <x-forms.dropify label="Avatar (Only Image are allowed)" type="file" name="avatar"
                                ...
                                <x-forms.button type="button" label="Reset" class="btn-danger" icon-class="fas fa-redo"
                                    on-click="resetForm('userFrom')" />


                                @isset($user)
                                    <x-forms.button type="submit" label="Update" class="btn btn-success"
                                        icon-class="fas fa-arrow-circle-up" />
                                @else
                                    <x-forms.button type="submit" label="Create" class="btn btn-primary"
