...
class SettingSeeder extends Seeder
{
    ...
    {
        // General Settings
        Setting::updateOrCreate(['name' => 'site_title', 'value' => 'Asiatic MCL']);
        Setting::updateOrCreate(['name' => 'site_description', 'value' => 'A Asiatic starter kit for website.']);
        ...
        Setting::updateOrCreate(['name' => 'mail_from_name', 'value' => 'Asiatic']);
